...
if(NOT TARGET OpenSSL::Crypto OR NOT TARGET OpenSSL::SSL)
    ...
    set(OPENSSL_INCLUDE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/${DIRLIBOPENSSL}/include CACHE INTERNAL "")
...
elseif (IOSBUILD OR ANDROIDBUILD)
    message(STATUS "Not going to build libgmp as it is pre-build in third-party...")
elseif(NOT OPENSSL_ONLY)
    message(STATUS "Going to build libgmp from source...")

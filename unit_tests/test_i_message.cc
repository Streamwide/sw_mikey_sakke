...
TEST(test_i_message, i_message_gmk) {
    ...
    struct mikey_sakke_key_data* alice_gmk = mikey_sakke_get_key_data(alice_incoming, GMK);
    ...
    struct mikey_sakke_key_data* bob_gmk = mikey_sakke_get_key_data(bob_incoming, GMK);
...
TEST(test_i_message, i_message_csk) {
    ...
    // Extract CSK/ID/RAND
    struct mikey_sakke_key_data* alice_csk = mikey_sakke_get_key_data(gms_incoming, CSK);

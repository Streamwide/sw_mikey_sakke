...
TEST(keygen, CSK_b64) {
    ...
    auto csk_b64      = mikey_sakke_gen_key_b64();
    auto csk_id_b64   = mikey_sakke_gen_key_id_b64(CSK);
    auto csk_rand_b64 = mikey_sakke_gen_key_b64();
...
TEST(keygen, GMK_b64) {
    ...
    auto gmk_b64      = mikey_sakke_gen_key_b64();
    auto gmk_id_b64   = mikey_sakke_gen_key_id_b64(GMK);
    auto gmk_rand_b64 = mikey_sakke_gen_key_b64();

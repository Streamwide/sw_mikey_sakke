...
MikeyExceptionMessageContent::MikeyExceptionMessageContent(MRef<MikeyMessage*> errMsg, const char* msg)
    : MikeyException(msg), errorMessageValue(errMsg) {}

MikeyExceptionMessageContent::~MikeyExceptionMessageContent() noexcept = default;
...
MikeyExceptionMessageLengthException::~MikeyExceptionMessageLengthException() noexcept = default;

MikeyExceptionAuthentication::MikeyExceptionAuthentication(const char* msg): MikeyException(msg) {}

MikeyExceptionAuthentication::~MikeyExceptionAuthentication() noexcept = default;

MikeyExceptionUnacceptable::MikeyExceptionUnacceptable(const char* msg): MikeyException(msg) {}

MikeyExceptionUnacceptable::~MikeyExceptionUnacceptable() noexcept = default;

MikeyExceptionUnimplemented::MikeyExceptionUnimplemented(const char* msg): MikeyException(msg) {}

MikeyExceptionUnimplemented::~MikeyExceptionUnimplemented() noexcept = default;

MikeyExceptionNoKey::MikeyExceptionNoKey(const char* msg): MikeyException(msg) {}

MikeyExceptionNoKey::~MikeyExceptionNoKey() noexcept = default;
